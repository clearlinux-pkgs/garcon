...
%prep
%setup -q -n garcon-0.8.0
cd %{_builddir}/garcon-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609287001
...
cp %{_builddir}/garcon-0.8.0/COPYING %{buildroot}/usr/share/package-licenses/garcon/6175d7c9784f74f7a17e17195c0904c7ad080045
%make_install
%find_lang garcon
