...
Source0  : https://archive.xfce.org/src/xfce/garcon/4.18/garcon-4.18.2.tar.bz2
...
%prep
%setup -q -n garcon-4.18.2
cd %{_builddir}/garcon-4.18.2
pushd ..
cp -a garcon-4.18.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720026868
...
/usr/share/icons/hicolor/64x64/apps/org.xfce.garcon.png
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgarcon-1.so.0.0.0
/V3/usr/lib64/libgarcon-gtk3-1.so.0.0.0
