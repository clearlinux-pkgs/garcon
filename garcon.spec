...
Source0  : https://archive.xfce.org/src/xfce/garcon/4.16/garcon-4.16.1.tar.bz2
...
%prep
%setup -q -n garcon-4.16.1
cd %{_builddir}/garcon-4.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624757668
...
cp %{_builddir}/garcon-4.16.1/COPYING %{buildroot}/usr/share/package-licenses/garcon/6175d7c9784f74f7a17e17195c0904c7ad080045
%make_install
%find_lang garcon
