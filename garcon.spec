...
Source0  : https://archive.xfce.org/src/xfce/garcon/4.18/garcon-4.18.0.tar.bz2
...
%prep
%setup -q -n garcon-4.18.0
cd %{_builddir}/garcon-4.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671135342
